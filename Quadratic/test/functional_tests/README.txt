Place most updated version of qsolver into this directory for testing.

===============================================================================
functional_test_suite.sh

This script executes a set of test sets each containing it's own test cases by executing qsolver and redirecting
...
More information including input, output, and expected output is provided to
in the log.
